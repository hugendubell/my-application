...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelper listener) {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int i1, int i) {
        if (listener!=null)
            listener.onSwiped(viewHolder,i,viewHolder.getAdapterPosition());
    }
